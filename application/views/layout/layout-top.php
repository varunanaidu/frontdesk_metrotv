...
<head>
	...
	<title>FRONTDESK MEDIA GROUP</title>
    ...
    <link href="<?php echo base_url(); ?>assets/vendor/select2/css/select2.min.css" rel="stylesheet" media="all">
	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url() ?>">
				...
				<div class="sidebar-brand-text mx-3">FRONTDESK</div>
			</a>
			...
			<li class="nav-item active">
				<a class="nav-link" href="<?= base_url() ?>">
					...
					<a class="nav-link" href="<?= base_url().'location' ?>">
						...
						<a class="nav-link" href="<?= base_url().'userfd' ?>">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
        	...
        	<!-- Nav Item - Alerts -->
                    ...
                    <li class="nav-item dropdown no-arrow">
                    	...
                    	data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    	<span class="mr-2 d-none d-lg-inline text-gray-600 small"><?= $role_name . ' - ' . $location_name ?></span>
                    ...
                    <a class="dropdown-item" href="javascript:void(0)" id="btn-cp">
