                                ...
                                <div class="p-5">
                                    ...
                                    <form method="POST" id="login-form" accept-charset="UTF-8">
                                        <div class="form-group">
                                            <select name="location" class="form-control form-control-user" id="location">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="username" id="username" class="form-control form-control-user" id="exampleInputEmail" placeholder="Username">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-user btn-block" id="submitBtn">Login</button>
                                    </form>
                                    <hr>
                                </div>
                            </div>
